    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center py-18 w-[304px]">
                ...
                className=" bg-zinc-800 px-6 py-2 m-4 rounded-md border-transparent leading-6 hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
                >
                    <p className="my-2 text-zinc-100">Quero enviar outro</p>
                </button>
